...
public class DevicesListActivity extends Activity {
    ...
    private void doDiscovery() {
        ...
        if (mBluetoothDevice.isBluetooth_discovering()) {
        	mBluetoothDevice.discoveryBluetooth_Cancel();
        }

        // Request discover from BluetoothAdapter
        mBluetoothDevice.discoveryBluetooth_Start();
    }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (mBluetoothDevice.Action_Bluetooth_Discovery_Finish.equals(action)) {
    ...
    protected void onDestroy() {
        ...
        if (mBluetoothDevice.getBluetoothAdapter() != null) {
            mBluetoothDevice.discoveryBluetooth_Cancel();
        }
